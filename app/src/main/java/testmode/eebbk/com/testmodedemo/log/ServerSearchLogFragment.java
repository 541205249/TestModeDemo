 ...
 * 后台搜索日志页
 */
public class ServerSearchLogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_log_server_search, container, false);
        initView(view);
        return view;
    }

    private void initView(View view) {
        mLogRv = (RecyclerView) view.findViewById(R.id.log_server_search_rv);
        mStatisticsTv = (TextView) view.findViewById(R.id.log_server_search_statistics_tv);
        mSuccessBtn = (Button) view.findViewById(R.id.log_server_search_success_btn);
        mFailBtn = (Button) view.findViewById(R.id.log_server_search_fail_btn);

        mLogAdapter = new LogAdapter();
        mLogAdapter.insertData(DataRepository.getInstance().getData(Constant.LogTarget.ServerSearch.FILTER));
