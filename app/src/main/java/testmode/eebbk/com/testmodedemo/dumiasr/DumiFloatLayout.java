 ...
 * @date 2018/4/18
 */
public class DumiFloatLayout extends FloatLayout {
    private static final String TAG = DumiFloatLayout.class.getSimpleName();
    ...
    public DumiFloatLayout(Context context) {
        this(context, null);
    }

    public DumiFloatLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
