 ...
 * 语义理解日志页
 */
public class SemanticLogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_log_semantic, container, false);
        initView(view);
        return view;
    }

    private void initView(View view) {
        mLogRv = (RecyclerView) view.findViewById(R.id.log_semantic_rv);
        mStatisticsTv = (TextView) view.findViewById(R.id.log_semantic_statistics_tv);
        mSuccessBtn = (Button) view.findViewById(R.id.log_semantic_success_btn);
        mFailBtn = (Button) view.findViewById(R.id.log_semantic_fail_btn);

        mLogAdapter = new LogAdapter();
        mLogAdapter.insertData(DataRepository.getInstance().getData(Constant.LogTarget.Semantic.FILTER));
    ...
    private void updateStatistics() {
        ...
        mStatisticsTv.setText(getString(R.string.semantic_statistics,
                totalNumber,
                successNumber,
                failNumber,
