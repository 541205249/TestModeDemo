 ...
 * APP端页面展示日志页
 */
public class DisplayLogFragment extends Fragment {
    ...
    private void initView(View view) {
        mLogRv = (RecyclerView) view.findViewById(R.id.log_display_rv);
        mStatisticsTv = (TextView) view.findViewById(R.id.log_display_statistics_tv);

        mLogAdapter = new LogAdapter();
        mLogAdapter.insertData(DataRepository.getInstance().getData(Constant.LogTarget.Display.FILTER));
    ...
    private void updateStatistics() {
        ...
        mStatisticsTv.setText(getString(R.string.display_statistics,
